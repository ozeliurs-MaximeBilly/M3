public class Client {
    public static void main(String[] args) {
        ...
        TypeComp contexteCourant = new TypeComp();

        contexteCourant.changerComp(new CompCIS());
        System.out.println(contexteCourant.comparer("Fugit tempore voluptatem illum dolorem similique", corpus, 200));
